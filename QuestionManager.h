...
private:
    ...
    [[nodiscard]] std::string GetExercisesStatusText() const noexcept;
...
public:
    ...
    [[nodiscard]] EFileSaveResult SaveExerciseStats() const;
    ...
    [[nodiscard]] bool IsEnd() const noexcept { return current_question == v_exercise.end(); }
